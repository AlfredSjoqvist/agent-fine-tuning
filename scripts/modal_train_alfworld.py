...
def train_test() -> dict:
    ...
    cmd = [
        ...
        "trainer.experiment_name=alfworld_learning_qwen3b",
        ...
        "trainer.default_local_dir=/output/ckpts/alfworld_learning_run1",
        "data.train_files=/output/data/alfworld_pnp/train.parquet",
        "data.val_files=/output/data/alfworld_pnp/val.parquet",
